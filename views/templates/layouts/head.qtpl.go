...
<head>
    ...
    `)
	//line layouts/head.qtpl:77
	for i := 0; i < len(head.Scripts); i++ {
		//line layouts/head.qtpl:77
		qw422016.N().S(`
        `)
		//line layouts/head.qtpl:78
