...
//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:1
package layouts
...
//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:5
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:6
...
//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:16
func (head *HeadHTMLPage) StreamHeadHTML(qw422016 *qt422016.Writer) {
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:16
	qw422016.N().S(`
<!DOCTYPE html>
<html lang="`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:18
...
<head>
    ...
    <meta artel='noSC'>
    <meta charset="`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:22
    ...
    `)
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:26
	for i := 0; i < len(head.MetaTags); i++ {
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:26
		qw422016.N().S(`
        `)
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:27
		qw422016.E().S(head.MetaTags[i])
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:27
		qw422016.N().S(`
    `)
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:28
	}
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:28
	qw422016.N().S(`
    <title>`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:29
    ...
    `)
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:52
	for i := 0; i < len(head.LinkStyles); i++ {
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:52
		qw422016.N().S(`
        `)
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:53
		qw422016.E().S(head.LinkStyles[i])
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:53
		qw422016.N().S(`
    `)
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:54
	}
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:54
	qw422016.N().S(`
    ...
    `)
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:77
	for i := 0; i < len(head.Scripts); i++ {
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:77
		qw422016.N().S(`
        `)
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:78
		qw422016.E().S(head.Scripts[i])
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:78
		qw422016.N().S(`
    `)
		//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:79
	}
	//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:79
	qw422016.N().S(`
...
`)
//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:85
}
...
//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:90
...
`)
//line src/github.com/ruslanBik4/httpgo/views/templates/layouts/head.qtpl:105
}
