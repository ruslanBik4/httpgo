...
//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:1
package layouts
			...
			<div id="partner-topline" class="topline-inner-wrap">
				...
				<nav class="topline-navbar">
					<ul class="top-mnu-list">
						`)
	//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:10
	for name, link := range TopMenu {
		//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:10
		qw422016.N().S(`
                            <li class="top-mnu-item">
                                <a href="`)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:12
		qw422016.E().S(link)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:12
		qw422016.N().S(`">`)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:12
		...
		qw422016.N().S(`</a>
                        ...
                        `)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:14
	}
	//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:14
	qw422016.N().S(`
					</ul>
...
`)
//line ../../ruslanBik4/httpgo/views/templates/layouts/header.qtpl:25
}
