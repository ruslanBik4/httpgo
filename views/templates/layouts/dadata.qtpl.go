...
//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:1
package layouts
...
//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:3
var (
	_ = qtio422016.Copy
...
`)
//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:8
}
...
//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:11
func StreamDadataScript(qw422016 *qt422016.Writer, Inputs map[string][]string) {
	//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:11
	qw422016.N().S(`
<script>
    `)
	//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:13
	for id, typeS := range Inputs {
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:13
		qw422016.N().S(`
        $("#`)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:14
		qw422016.N().S(id)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:14
		qw422016.N().S(`").suggestions({
            ...
            type: "`)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:17
		...
		qw422016.N().S(`",
            ...
            onSelect: `)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:20
		qw422016.N().S(typeS[1])
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:20
		qw422016.N().S(`,
        });
    `)
		//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:22
	}
	//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:22
	qw422016.N().S(`
</script>
`)
//line ../../ruslanBik4/httpgo/views/templates/layouts/dadata.qtpl:24
}
