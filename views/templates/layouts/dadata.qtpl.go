...
<script>
	...
	for id, typeS := range Inputs {
		...
		qw422016.N().S(`",
            ...
            onSelect: `)
		//line layouts/dadata.qtpl:20
		qw422016.N().S(typeS[1])
		//line layouts/dadata.qtpl:20
		qw422016.N().S(`,
        });
    `)
		//line layouts/dadata.qtpl:22
	}
	//line layouts/dadata.qtpl:22
	qw422016.N().S(`
</script>
`)
//line layouts/dadata.qtpl:24
}
