...
//line layouts/owner_menu.qtpl:1
package layouts
...
//line layouts/owner_menu.qtpl:5
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line layouts/owner_menu.qtpl:6
...
<div id="catalog_pane">
    <ul class="nav">
        `)
	//line layouts/owner_menu.qtpl:18
	for name, item := range menu.TopMenu {
		//line layouts/owner_menu.qtpl:18
		qw422016.N().S(`
            <li><a href="`)
		//line layouts/owner_menu.qtpl:19
		...
		qw422016.N().S(`</a></li>
        `)
		//line layouts/owner_menu.qtpl:20
	}
	//line layouts/owner_menu.qtpl:20
	qw422016.N().S(`
    </ul>
...
`)
//line layouts/owner_menu.qtpl:23
}
