...
//line owner_menu.qtpl:5
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line owner_menu.qtpl:6
...
<div id="catalog_pane">
    <ul class="nav">
        `)
	//line owner_menu.qtpl:18
	for name, item := range menu.TopMenu {
		//line owner_menu.qtpl:18
		qw422016.N().S(`
            <li><a href="`)
		//line owner_menu.qtpl:19
