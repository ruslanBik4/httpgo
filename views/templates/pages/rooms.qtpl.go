...
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:1
package pages
...
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:2
...
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:31
func (d *DiscountAllData) StreamJSON(qw422016 *qt422016.Writer) {
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:31
	qw422016.N().S(`{"min_points_count": "`)
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:33
	qw422016.N().D(d.Min_points_count)
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:33
	qw422016.N().S(`","max_points_count": "`)
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:34
	qw422016.N().D(d.Max_points_count)
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:34
	qw422016.N().S(`"`)
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:35
	if len(d.DiscountMain.Rules) > 0 {
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:35
		qw422016.N().S(`,"discountMain":{"rules":[`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:40
		for j, s := range d.DiscountMain.Rules {
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:40
			qw422016.N().S(`{"value":`)
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:42
			qw422016.N().Q(s.Value)
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:42
			qw422016.N().S(`,"count_use_for": "`)
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:43
			qw422016.N().D(s.Count_use_for)
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:43
			qw422016.N().S(`"}`)
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:45
			if j+1 < len(d.DiscountMain.Rules) {
				//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:45
				qw422016.N().S(`,`)
				//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:45
			}
			//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:46
		}
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:46
		qw422016.N().S(`]}`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:50
	}
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:52
	if d.DiscountChildren.ChildRules.Value > "" && d.DiscountChildren.ChildRules.Count_use_for > 0 {
		...
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:57
		qw422016.N().Q(d.DiscountChildren.ChildRules.Value)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:57
		qw422016.N().S(`,"count_use_for":"`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:58
		qw422016.N().D(d.DiscountChildren.ChildRules.Count_use_for)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:58
		qw422016.N().S(`"}}`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:63
	}
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:65
	if d.DiscountTerm.DiscountLongTermRules.Main_place_only > 0 && d.DiscountTerm.DiscountLongTermRules.Value > "" && d.DiscountTerm.DiscountLongTermRules.Condition > 0 && d.DiscountTerm.DiscountLongTermRules.Night_count > 0 {
		...
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:70
		qw422016.N().D(d.DiscountTerm.DiscountLongTermRules.Main_place_only)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:70
		qw422016.N().S(`","value":`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:71
		qw422016.N().Q(d.DiscountTerm.DiscountLongTermRules.Value)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:71
		qw422016.N().S(`,"condition":"`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:72
		qw422016.N().D(d.DiscountTerm.DiscountLongTermRules.Condition)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:72
		qw422016.N().S(`","night_count":"`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:73
		qw422016.N().D(d.DiscountTerm.DiscountLongTermRules.Night_count)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:73
		qw422016.N().S(`"}}`)
		//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:76
	}
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:76
	qw422016.N().S(`}`)
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:78
}
...
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:79
func StreamPutRoomsHead(qw422016 *qt422016.Writer) {
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:79
	qw422016.N().S(`<div class="main-form-wrap">`)
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:81
}
...
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:83
func StreamPutRoomsEnd(qw422016 *qt422016.Writer) {
	//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:83
	qw422016.N().S(`</div>`)
//line ../../ruslanBik4/httpgo/views/templates/pages/rooms.qtpl:85
}
