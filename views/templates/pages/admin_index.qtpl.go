...
//line pages/admin_index.qtpl:5
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line pages/admin_index.qtpl:6
...
//line pages/admin_index.qtpl:15
...
<header class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="#">`)
	//line pages/admin_index.qtpl:35
	...
	qw422016.N().S(`</a>
            <div class="nav-collapse ">
                ...
                <nav>
                    <ul class="nav">
                        `)
	//line pages/admin_index.qtpl:46
	for name, item := range body.TopMenu {
		//line pages/admin_index.qtpl:46
		qw422016.N().S(`
                            <li `)
		//line pages/admin_index.qtpl:47
		...
		qw422016.N().S(`>
                                <a href="`)
		//line pages/admin_index.qtpl:48
		...
		qw422016.N().S(`</a>
                        ...
                        `)
		//line pages/admin_index.qtpl:50
	}
	//line pages/admin_index.qtpl:50
	qw422016.N().S(`
                    </ul>
...
<div id="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span3">
            <div id="catalog_pane"  class="well sidebar-nav">
                `)
	//line pages/admin_index.qtpl:63
	for name, item := range body.Catalog {
		//line pages/admin_index.qtpl:63
		qw422016.N().S(`
                    <li><a href="`)
		//line pages/admin_index.qtpl:64
		qw422016.E().S(item.Link)
		//line pages/admin_index.qtpl:64
		qw422016.N().S(`">`)
		//line pages/admin_index.qtpl:64
		...
		qw422016.N().S(`</a></li>
                `)
		//line pages/admin_index.qtpl:65
	}
	//line pages/admin_index.qtpl:65
	qw422016.N().S(`
	...
	//line pages/admin_index.qtpl:69
...
`)
//line pages/admin_index.qtpl:79
}
