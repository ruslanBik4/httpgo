...
//line admin_index.qtpl:5
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line admin_index.qtpl:6
	...
	qw422016.N().S(`</a>
            <div class="nav-collapse ">
                ...
                <nav>
                    <ul class="nav">
                        `)
	//line admin_index.qtpl:46
	for name, item := range body.TopMenu {
		//line admin_index.qtpl:46
		qw422016.N().S(`
                            <li `)
		//line admin_index.qtpl:47
    ...
    <div class="row-fluid">
        <div class="span3">
            <div id="catalog_pane"  class="well sidebar-nav">
                `)
	//line admin_index.qtpl:63
	for name, item := range body.Catalog {
		//line admin_index.qtpl:63
		qw422016.N().S(`
                    <li><a href="`)
		//line admin_index.qtpl:64
		qw422016.E().S(item.Link)
		//line admin_index.qtpl:64
		qw422016.N().S(`">`)
		//line admin_index.qtpl:64
