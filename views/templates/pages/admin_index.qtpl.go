...
//line pages/admin_index.qtpl:9
var (
	_ = qtio422016.Copy
	_ = qt422016.AcquireByteBuffer
)

//line pages/admin_index.qtpl:10
    ...
    <div class="row-fluid">
        <div class="sidebar-section">
            <div id="catalog_pane"  class="well sidebar-nav">
                `)
	//line pages/admin_index.qtpl:29
	for name, item := range body.Catalog {
		//line pages/admin_index.qtpl:29
		qw422016.N().S(`
                    <li><a href="`)
		//line pages/admin_index.qtpl:30
		...
		qw422016.N().S(`</a></li>
                `)
		//line pages/admin_index.qtpl:31
	}
	//line pages/admin_index.qtpl:31
	qw422016.N().S(`
...
`)
	//line pages/admin_index.qtpl:41
	layouts.StreamFooterHTML(qw422016)
	//line pages/admin_index.qtpl:41
	qw422016.N().S(`
</body>
`)
//line pages/admin_index.qtpl:43
}
