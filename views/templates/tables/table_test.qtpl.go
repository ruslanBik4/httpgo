...
<paper-datatable data="{{data}}">
	<paper-datatable-column header="ID пользователя" property="id" type="Number"></paper-datatable-column>
	<paper-datatable-column header="Че жрет" property="title" type="String"></paper-datatable-column>
	<paper-datatable-column header="Скоько каллорий" property="calories" type="Number"></paper-datatable-column>
...
`)
//line views/templates/tables/table_test.qtpl:41
}
