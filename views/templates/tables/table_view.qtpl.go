...
func (query *QueryStruct) StreamFineTable(qw422016 *qt422016.Writer) {
	...
	qw422016.N().S(`
        `)
	//line table_view.qtpl:16
	if err := query.beforeRender(); err != nil {
		return
	}

	//line table_view.qtpl:19
	qw422016.N().S(`
...
<paper-datatable data="{{data}}" progress="True">
	...
	for idx, fieldName := range query.columns {
		...
		qw422016.N().S(`" default="-"
	            type=
	            `)
		//line table_view.qtpl:36
		switch fieldStruct.DATA_TYPE {
		//line table_view.qtpl:37
		case "varchar":
			//line table_view.qtpl:37
			qw422016.N().S(` "String" align="left"
	            `)
		//line table_view.qtpl:38
		case "date":
			//line table_view.qtpl:38
			qw422016.N().S(` "Date"
	            `)
		//line table_view.qtpl:39
		case "set", "enum":
			//line table_view.qtpl:39
			qw422016.N().S(` "Array"
	            `)
		//line table_view.qtpl:40
		default:
			//line table_view.qtpl:40
			qw422016.N().S(`  "Number" align="right"
	            `)
			//line table_view.qtpl:41
		}
		//line table_view.qtpl:41
		qw422016.N().S(`
	            sortable `)
...
<div class='thead' id='thead' >
	...
	//line table_view.qtpl:116
	qw422016.N().S(`
            `)
	//line table_view.qtpl:117
	for idx, fieldName := range query.columns {
		//line table_view.qtpl:117
		qw422016.N().S(`
                `)
		//line table_view.qtpl:119
		fieldStruct := query.fields[idx]
...
func StreamShowTable(qw422016 *qt422016.Writer, tableName string, fields forms.FieldsTable, rows *sql.Rows) {
	...
	//line table_view.qtpl:196
	qw422016.N().S(`
        `)
	//line table_view.qtpl:197
	query.streamrenderHeadTables(qw422016)
	//line table_view.qtpl:197
	qw422016.N().S(`
        `)
	//line table_view.qtpl:198
	query.streamrenderBodyTables(qw422016)
	//line table_view.qtpl:198
	qw422016.N().S(`
`)
//line table_view.qtpl:199
}
...
//line table_view.qtpl:200
func (query *QueryStruct) streamrenderBodyTables(qw422016 *qt422016.Writer) {
	//line table_view.qtpl:200
	qw422016.N().S(`
<div id="table_body" >
        `)
	//line table_view.qtpl:202
	for query.Rows.Next() {
		//line table_view.qtpl:202
		qw422016.N().S(`
            `)
		//line table_view.qtpl:204
		if err := query.Rows.Scan(query.row...); err != nil {
			log.Println(err)
			continue
		}
		...
		//line table_view.qtpl:210
		qw422016.N().S(`
        <div class='tr' style='$style_div'>
            `)
		//line table_view.qtpl:212
		for idx, rawField := range query.row {
			//line table_view.qtpl:212
			qw422016.N().S(`
                `)
			//line table_view.qtpl:214
			var fieldStruct *forms.FieldStructure
			...
			//line table_view.qtpl:234
			qw422016.N().S(`
                <div name="`)
			//line table_view.qtpl:235
			qw422016.E().S(key)
			//line table_view.qtpl:235
			qw422016.N().S(`" class="td `)
			//line table_view.qtpl:235
			...
			qw422016.N().S(`"
                         style="`)
			//line table_view.qtpl:236
			qw422016.E().S(fieldStruct.CSSStyle)
			//line table_view.qtpl:236
			qw422016.N().S(`;margin:auto; height:auto;">
                `)
			//line table_view.qtpl:237
			if idx == 0 {
				//line table_view.qtpl:237
				qw422016.N().S(`
                    <a href="`)
				//line table_view.qtpl:238
				...
				if key == "parent_id" {
					...
					case "text":
						...
						qw422016.N().S(`>
                                    `)
						//line table_view.qtpl:275
						qw422016.N().S(val)
						//line table_view.qtpl:275
						qw422016.N().S(`
                                </p>
                            `)
					//line table_view.qtpl:277
					case "blob":
						//line table_view.qtpl:277
						qw422016.N().S(`
                                <image src="/images/expand_hover.png" />
                            `)
					//line table_view.qtpl:279
					default:
						//line table_view.qtpl:279
						qw422016.N().S(`
                                `)
						//line table_view.qtpl:280
						if fieldStruct.LinkTD > "" {
							//line table_view.qtpl:280
							qw422016.N().S(`
                                 <a href="`)
							//line table_view.qtpl:281
							...
							qw422016.N().S(`</a>
                                 `)
							//line table_view.qtpl:282
						} else {
							//line table_view.qtpl:282
							qw422016.N().S(`
                                    `)
							//line table_view.qtpl:283
							qw422016.E().S(val)
							//line table_view.qtpl:283
							qw422016.N().S(`
                                 `)
							//line table_view.qtpl:284
						}
						//line table_view.qtpl:284
						qw422016.N().S(`
                            `)
						//line table_view.qtpl:285
					}
					//line table_view.qtpl:285
					qw422016.N().S(`
                        `)
					//line table_view.qtpl:286
				}
				//line table_view.qtpl:286
				qw422016.N().S(`
                `)
				//line table_view.qtpl:287
			}
			//line table_view.qtpl:287
			qw422016.N().S(`
                </div> <!-- field -->
            `)
			//line table_view.qtpl:289
		}
		//line table_view.qtpl:289
		qw422016.N().S(`
            `)
		//line table_view.qtpl:290
		for _, fieldStruct := range query.PostFields {
			//line table_view.qtpl:290
			qw422016.N().S(`
                <div name="`)
			//line table_view.qtpl:291
			...
			qw422016.N().S(`"
                         style="`)
			//line table_view.qtpl:292
			qw422016.E().S(fieldStruct.CSSStyle)
			//line table_view.qtpl:292
			qw422016.N().S(`;margin:auto; height:auto;" >
                    `)
			//line table_view.qtpl:293
			qw422016.N().S(fieldStruct.Html)
			//line table_view.qtpl:293
			qw422016.N().S(`
                </div> <!-- field -->
            `)
			//line table_view.qtpl:295
		}
		//line table_view.qtpl:295
		qw422016.N().S(`
        </div> <!-- tr -->
        `)
		//line table_view.qtpl:297
	}
	//line table_view.qtpl:297
	qw422016.N().S(`
    </div>
...
func streamrenderFilterSelect(qw422016 *qt422016.Writer, key string, fieldStruct *forms.FieldStructure) {
	...
	qw422016.N().S(`" onchange="return FilterIsModified( event, this);">
        ...
        `)
	//line table_view.qtpl:304
	qw422016.N().S(fieldStruct.Html)
	//line table_view.qtpl:304
	qw422016.N().S(`
    </select>
`)
//line table_view.qtpl:306
}
...
func streaminputFilterField(qw422016 *qt422016.Writer, key, nameTable string, fieldStruct *forms.FieldStructure) {
 ...
 <div title="`)
	...
	qw422016.N().S(`">
                        `)
	//line table_view.qtpl:309
	if key == "parent_id" {
		//line table_view.qtpl:309
		qw422016.N().S(`
                                `)
		//line table_view.qtpl:310
		fieldStruct.GetOptions(nameTable, "")

		//line table_view.qtpl:310
		qw422016.N().S(`
                                `)
		//line table_view.qtpl:311
		streamrenderFilterSelect(qw422016, key, fieldStruct)
		//line table_view.qtpl:311
		qw422016.N().S(`
                        `)
		//line table_view.qtpl:312
	} else if strings.HasPrefix(key, "id_") {
		//line table_view.qtpl:312
		qw422016.N().S(`
                                `)
		//line table_view.qtpl:313
		fieldStruct.GetOptions(key[3:], "")

		//line table_view.qtpl:313
		qw422016.N().S(`
                                `)
		//line table_view.qtpl:314
		streamrenderFilterSelect(qw422016, key, fieldStruct)
		//line table_view.qtpl:314
		qw422016.N().S(`
                        `)
		//line table_view.qtpl:315
	} else {
		//line table_view.qtpl:315
		qw422016.N().S(`
                            `)
		//line table_view.qtpl:316
		switch fieldStruct.DATA_TYPE {
		//line table_view.qtpl:317
		case "tinyint":
			//line table_view.qtpl:317
			qw422016.N().S(`
                                    `)
			//line table_view.qtpl:318
			forms.StreamRenderCheckBox(qw422016, key, "1", "", 1, "", "", "", "")
			//line table_view.qtpl:318
			qw422016.N().S(`
                            `)
		//line table_view.qtpl:319
		case "enum":
			//line table_view.qtpl:319
			qw422016.N().S(`
                                `)
			//line table_view.qtpl:320
			t := fieldStruct.RenderEnum(key, "", "", "", "")

			//line table_view.qtpl:320
			qw422016.N().S(`
                                `)
			//line table_view.qtpl:321
			qw422016.N().S(t)
			//line table_view.qtpl:321
			qw422016.N().S(`
                            `)
		//line table_view.qtpl:322
		case "set":
			//line table_view.qtpl:322
			qw422016.N().S(`
                                `)
			//line table_view.qtpl:323
			t := fieldStruct.RenderSet(key, "", "", "", "")

			//line table_view.qtpl:323
			qw422016.N().S(`
                                `)
			//line table_view.qtpl:324
			qw422016.N().S(t)
			//line table_view.qtpl:324
			qw422016.N().S(`
               `)
		//line table_view.qtpl:325
		default:
			//line table_view.qtpl:325
			qw422016.N().S(`
                        <input id="`)
			//line table_view.qtpl:326
			qw422016.E().S(key)
			//line table_view.qtpl:326
			qw422016.N().S(`" name="`)
			//line table_view.qtpl:326
			...
			qw422016.N().S(`" type=
                        ...
                        `)
			//line table_view.qtpl:328
			if fieldStruct.InputType > "" {
				//line table_view.qtpl:328
				qw422016.N().S(`
                            "`)
				//line table_view.qtpl:329
				qw422016.E().S(fieldStruct.InputType)
				//line table_view.qtpl:329
				qw422016.N().S(`"
                        `)
				//line table_view.qtpl:330
			} else if fieldStruct.DATA_TYPE == "int" || fieldStruct.DATA_TYPE == "double" {
				//line table_view.qtpl:330
				qw422016.N().S(`
                            "number" `)
				//line table_view.qtpl:331
			...
			qw422016.N().S(`
                        ...
                        />
               `)
			//line table_view.qtpl:346
		}
		//line table_view.qtpl:346
		qw422016.N().S(`
        `)
		//line table_view.qtpl:347
	}
	//line table_view.qtpl:347
	qw422016.N().S(`
  </div>
`)
//line table_view.qtpl:349
}
