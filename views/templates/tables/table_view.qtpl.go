...
//line tables/table_view.qtpl:14
var (
	_ = qtio422016.Copy
...
func (query *QueryStruct) StreamFineTable(qw422016 *qt422016.Writer) {
	...
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:16
	if err := query.beforeRender(); err != nil {
		return
	}

	//line tables/table_view.qtpl:19
	qw422016.N().S(`
...
<paper-datatable data="{{data}}" progress="True">
	...
	for idx, fieldName := range query.columns {
		...
		qw422016.N().S(`" default="-"
	            type=
	            `)
		//line tables/table_view.qtpl:36
		switch fieldStruct.DATA_TYPE {
		//line tables/table_view.qtpl:37
		case "varchar":
			//line tables/table_view.qtpl:37
			qw422016.N().S(` "String" align="left"
	            `)
		//line tables/table_view.qtpl:38
		case "date":
			//line tables/table_view.qtpl:38
			qw422016.N().S(` "Date"
	            `)
		//line tables/table_view.qtpl:39
		case "set", "enum":
			//line tables/table_view.qtpl:39
			qw422016.N().S(` "Array"
	            `)
		//line tables/table_view.qtpl:40
		default:
			//line tables/table_view.qtpl:40
			qw422016.N().S(`  "Number" align="right"
	            `)
			//line tables/table_view.qtpl:41
		}
		//line tables/table_view.qtpl:41
		qw422016.N().S(`
	            sortable `)
		//line tables/table_view.qtpl:42
		...
		qw422016.N().S(`></paper-datatable-column>
            `)
		//line tables/table_view.qtpl:43
	}
	//line tables/table_view.qtpl:43
	qw422016.N().S(`
</paper-datatable>
...
<script>
        ...
        app.data = [
        `)
	//line tables/table_view.qtpl:49
	for query.Rows.Next() {
		//line tables/table_view.qtpl:49
		qw422016.N().S(`
            `)
		//line tables/table_view.qtpl:51
		if err := query.Rows.Scan(query.row...); err != nil {
			log.Println(err)
			continue
		}

		//line tables/table_view.qtpl:55
		qw422016.N().S(`
`)
		//line tables/table_view.qtpl:57
		qw422016.N().S(`{`)
		//line tables/table_view.qtpl:59
		for idx, rawField := range query.row {
			//line tables/table_view.qtpl:61
			...
			//line tables/table_view.qtpl:71
			qw422016.E().S(key)
			//line tables/table_view.qtpl:71
			qw422016.N().S(`:`)
			//line tables/table_view.qtpl:72
			switch fieldStruct.DATA_TYPE {
			//line tables/table_view.qtpl:73
			case "varchar", "text", "set", "enum":
				...
				//line tables/table_view.qtpl:73
				qw422016.N().S(`'`)
			//line tables/table_view.qtpl:74
			case "date", "datetime":
				//line tables/table_view.qtpl:74
				qw422016.N().S(`'`)
				//line tables/table_view.qtpl:74
				...
				//line tables/table_view.qtpl:74
				qw422016.N().S(`'`)
			//line tables/table_view.qtpl:75
			case "int", "tinyint":
				//line tables/table_view.qtpl:75
				qw422016.N().S(`'`)
				//line tables/table_view.qtpl:75
				...
				//line tables/table_view.qtpl:75
				qw422016.N().S(`'`)
			//line tables/table_view.qtpl:76
			case "set enum":
				//line tables/table_view.qtpl:78
				fields := enumValidator.FindAllStringSubmatch(fieldStruct.COLUMN_TYPE, -1)
				comma := ""

				//line tables/table_view.qtpl:80
				qw422016.N().S(`[`)
				//line tables/table_view.qtpl:82
				for _, value := range fields {
					//line tables/table_view.qtpl:83
					qw422016.E().S(comma)
					//line tables/table_view.qtpl:83
					qw422016.N().S(`'`)
					//line tables/table_view.qtpl:83
					...
					//line tables/table_view.qtpl:83
					qw422016.N().S(`'`)
					//line tables/table_view.qtpl:84
					comma = ","

					//line tables/table_view.qtpl:85
				}
				//line tables/table_view.qtpl:85
				qw422016.N().S(`]`)
			//line tables/table_view.qtpl:87
			case "blob":
				//line tables/table_view.qtpl:87
				qw422016.N().S(`'<image src="/images/expand_hover.png" />'`)
			//line tables/table_view.qtpl:88
			default:
				//line tables/table_view.qtpl:88
				qw422016.N().S(`"`)
				//line tables/table_view.qtpl:88
				...
				//line tables/table_view.qtpl:88
				qw422016.N().S(`"`)
				//line tables/table_view.qtpl:89
			}
			//line tables/table_view.qtpl:89
			qw422016.N().S(`,`)
			//line tables/table_view.qtpl:90
		}
		//line tables/table_view.qtpl:90
		qw422016.N().S(`},`)
		//line tables/table_view.qtpl:92
	}
	//line tables/table_view.qtpl:92
	qw422016.N().S(`];`)
	//line tables/table_view.qtpl:95
	qw422016.N().S(`
...
`)
//line tables/table_view.qtpl:103
}
...
//line tables/table_view.qtpl:105
...
<div class='thead' id='thead' >
    <div class='tr' >
        `)
	//line tables/table_view.qtpl:112
	var figure, filterFields string
	if query.Order == "" {
		query.Order = "id"
	}

	//line tables/table_view.qtpl:116
	qw422016.N().S(`
            `)
	//line tables/table_view.qtpl:117
	for idx, fieldName := range query.columns {
		//line tables/table_view.qtpl:117
		qw422016.N().S(`
                `)
		//line tables/table_view.qtpl:119
		fieldStruct := query.fields[idx]
		...
		//line tables/table_view.qtpl:144
		qw422016.N().S(`
                `)
		//line tables/table_view.qtpl:145
		qw422016.N().S(`
                `)
		//line tables/table_view.qtpl:146
		if figure != fieldStruct.Figure {
			//line tables/table_view.qtpl:146
			qw422016.N().S(`
                    `)
			//line tables/table_view.qtpl:147
			if figure > "" {
				//line tables/table_view.qtpl:147
				qw422016.N().S(`
                        </div>
                    `)
				//line tables/table_view.qtpl:149
			}
			//line tables/table_view.qtpl:149
			qw422016.N().S(`
                    `)
			//line tables/table_view.qtpl:151
			figure = fieldStruct.Figure

			//line tables/table_view.qtpl:152
			qw422016.N().S(`
                    `)
			//line tables/table_view.qtpl:153
			if figure > "" {
				//line tables/table_view.qtpl:153
				qw422016.N().S(`
                            <div class='td-outer' style="outline: 1px inset gray;">
                                <div class='th' style="outline: 1px outset gray; padding-top: 1px;"> `)
				//line tables/table_view.qtpl:155
				qw422016.E().S(figure)
				//line tables/table_view.qtpl:155
				qw422016.N().S(`</div>
                    `)
				//line tables/table_view.qtpl:156
			}
			//line tables/table_view.qtpl:156
			qw422016.N().S(`
                `)
			//line tables/table_view.qtpl:157
		}
		//line tables/table_view.qtpl:157
		qw422016.N().S(`
                 <div title="`)
		//line tables/table_view.qtpl:158
		qw422016.E().S(fieldName)
		//line tables/table_view.qtpl:158
		...
		qw422016.N().S(`"
                 style="`)
		//line tables/table_view.qtpl:159
		qw422016.E().S(fieldStruct.CSSStyle)
		//line tables/table_view.qtpl:159
		qw422016.N().S(`">
                   <a href="`)
		//line tables/table_view.qtpl:160
		...
		qw422016.N().S(`</a>
            ...
            `)
		//line tables/table_view.qtpl:162
	}
	//line tables/table_view.qtpl:162
	qw422016.N().S(`
            `)
	//line tables/table_view.qtpl:163
	if figure > "" {
		//line tables/table_view.qtpl:163
		qw422016.N().S(`
                </div>
            `)
		//line tables/table_view.qtpl:165
	}
	//line tables/table_view.qtpl:165
	qw422016.N().S(`
    </div>
    <form name='fFilter' id='fFilter' class='form-simple tr thead' role='form' action='`)
	//line tables/table_view.qtpl:167
	qw422016.E().S(query.Href)
	//line tables/table_view.qtpl:167
    ...
    oninput='return FormIsModified(event, this);' onabort="alert('fFilter');">
        ...
        <input name="`)
	//line tables/table_view.qtpl:171
	qw422016.E().S(query.Tables[0].Name)
	//line tables/table_view.qtpl:171
	qw422016.N().S(`" hidden />
        `)
	//line tables/table_view.qtpl:172
...
`)
//line tables/table_view.qtpl:175
}
...
//line tables/table_view.qtpl:176
func (query *QueryStruct) StreamRenderTable(qw422016 *qt422016.Writer) {
	//line tables/table_view.qtpl:176
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:178
	if err := query.beforeRender(); err != nil {
		return
	}

	//line tables/table_view.qtpl:181
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:182
	query.streamrenderHeadTables(qw422016)
	//line tables/table_view.qtpl:182
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:183
	query.streamrenderBodyTables(qw422016)
	//line tables/table_view.qtpl:183
	qw422016.N().S(`
`)
//line tables/table_view.qtpl:184
}
...
func StreamShowTable(qw422016 *qt422016.Writer, tableName string, fields forms.FieldsTable, rows *sql.Rows) {
	...
	//line tables/table_view.qtpl:196
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:197
	query.streamrenderHeadTables(qw422016)
	//line tables/table_view.qtpl:197
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:198
	query.streamrenderBodyTables(qw422016)
	//line tables/table_view.qtpl:198
	qw422016.N().S(`
`)
//line tables/table_view.qtpl:199
}
...
//line tables/table_view.qtpl:200
func (query *QueryStruct) streamrenderBodyTables(qw422016 *qt422016.Writer) {
	//line tables/table_view.qtpl:200
	qw422016.N().S(`
<div id="table_body" >
        `)
	//line tables/table_view.qtpl:202
	for query.Rows.Next() {
		//line tables/table_view.qtpl:202
		qw422016.N().S(`
            `)
		//line tables/table_view.qtpl:204
		if err := query.Rows.Scan(query.row...); err != nil {
			log.Println(err)
			continue
		}
		...
		//line tables/table_view.qtpl:210
		qw422016.N().S(`
        <div class='tr' style='$style_div'>
            `)
		//line tables/table_view.qtpl:212
		for idx, rawField := range query.row {
			//line tables/table_view.qtpl:212
			qw422016.N().S(`
                `)
			//line tables/table_view.qtpl:214
			var fieldStruct *forms.FieldStructure
			...
			//line tables/table_view.qtpl:234
			qw422016.N().S(`
                <div name="`)
			//line tables/table_view.qtpl:235
			qw422016.E().S(key)
			//line tables/table_view.qtpl:235
			qw422016.N().S(`" class="td `)
			//line tables/table_view.qtpl:235
			...
			qw422016.N().S(`"
                         style="`)
			//line tables/table_view.qtpl:236
			qw422016.E().S(fieldStruct.CSSStyle)
			//line tables/table_view.qtpl:236
			qw422016.N().S(`;margin:auto; height:auto;">
                `)
			//line tables/table_view.qtpl:237
			if idx == 0 {
				//line tables/table_view.qtpl:237
				qw422016.N().S(`
                    <a href="`)
				//line tables/table_view.qtpl:238
				...
				qw422016.N().S(`</a>
                    `)
				//line tables/table_view.qtpl:240
				tablePrefix = fields.Name
				fields.ID, _ = strconv.Atoi(val)

				//line tables/table_view.qtpl:242
				qw422016.N().S(`
                `)
				//line tables/table_view.qtpl:243
			} else if fieldStruct.Html > "" {
				//line tables/table_view.qtpl:243
				qw422016.N().S(`
                    `)
				//line tables/table_view.qtpl:244
				qw422016.N().S(fieldStruct.Html)
				//line tables/table_view.qtpl:244
				qw422016.N().S(`
                `)
				//line tables/table_view.qtpl:245
			} else {
				//line tables/table_view.qtpl:245
				qw422016.N().S(`
                `)
				//line tables/table_view.qtpl:248
				qw422016.N().S(`
                        `)
				//line tables/table_view.qtpl:249
				if key == "parent_id" {
					//line tables/table_view.qtpl:249
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:250
					fieldStruct.StreamRenderParentSelect(qw422016, fields.Name, key, val, titleLabel, required, events, dataJson)
					//line tables/table_view.qtpl:250
					qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:251
				} else if strings.HasPrefix(key, "id_") {
					//line tables/table_view.qtpl:251
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:252
					fieldStruct.StreamRenderForeignSelect(qw422016, tablePrefix, key, val, titleLabel, required, events, dataJson)
					//line tables/table_view.qtpl:252
					qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:253
				} else if strings.HasPrefix(key, "setid_") || strings.HasPrefix(key, "nodeid_") {
					//line tables/table_view.qtpl:253
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:254
					fieldStruct.StreamRenderMultiSelect(qw422016, fields, tablePrefix, key, val, "См. ", required)
					//line tables/table_view.qtpl:254
					qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:255
				} else if strings.HasPrefix(key, "tableid_") {
					//line tables/table_view.qtpl:255
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:256
					fieldStruct.StreamRenderTable(qw422016, fields, tablePrefix, key, val, "Табл", required)
					//line tables/table_view.qtpl:256
					qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:257
				} else {
					//line tables/table_view.qtpl:257
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:258
					switch fieldStruct.DATA_TYPE {
					//line tables/table_view.qtpl:259
					case "tinyint":
						//line tables/table_view.qtpl:259
						qw422016.N().S(`
                                    `)
						//line tables/table_view.qtpl:261
						checked := ""
						if val == "1" {
							checked = "checked"
						}

						//line tables/table_view.qtpl:265
						qw422016.N().S(`
                                    `)
						//line tables/table_view.qtpl:266
						forms.StreamRenderCheckBox(qw422016, nameInput, "1", titleLabel, 1, checked, required, events, dataJson)
						//line tables/table_view.qtpl:266
						qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:267
					case "enum":
						//line tables/table_view.qtpl:267
						qw422016.N().S(`
                                `)
						//line tables/table_view.qtpl:268
						t := fieldStruct.RenderEnum(nameInput, val, required, events, dataJson)

						//line tables/table_view.qtpl:268
						qw422016.N().S(`
                                `)
						//line tables/table_view.qtpl:269
						qw422016.N().S(t)
						//line tables/table_view.qtpl:269
						qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:270
					case "set":
						//line tables/table_view.qtpl:270
						qw422016.N().S(`
                                `)
						//line tables/table_view.qtpl:271
						t := fieldStruct.RenderSet(nameInput, val, required, events, dataJson)

						//line tables/table_view.qtpl:271
						qw422016.N().S(`
                                `)
						//line tables/table_view.qtpl:272
						qw422016.N().S(t)
						//line tables/table_view.qtpl:272
						qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:273
					case "text":
						//line tables/table_view.qtpl:273
						qw422016.N().S(`
                                <p id="`)
						//line tables/table_view.qtpl:274
						qw422016.E().S(key)
						//line tables/table_view.qtpl:274
						qw422016.N().S(`" name="`)
						//line tables/table_view.qtpl:274
						...
						qw422016.N().S(`>
                                    `)
						//line tables/table_view.qtpl:275
						qw422016.N().S(val)
						//line tables/table_view.qtpl:275
						qw422016.N().S(`
                                </p>
                            `)
					//line tables/table_view.qtpl:277
					case "blob":
						//line tables/table_view.qtpl:277
						qw422016.N().S(`
                                <image src="/images/expand_hover.png" />
                            `)
					//line tables/table_view.qtpl:279
					default:
						//line tables/table_view.qtpl:279
						qw422016.N().S(`
                                `)
						//line tables/table_view.qtpl:280
						if fieldStruct.LinkTD > "" {
							//line tables/table_view.qtpl:280
							qw422016.N().S(`
                                 <a href="`)
							//line tables/table_view.qtpl:281
							...
							qw422016.N().S(`</a>
                                 `)
							//line tables/table_view.qtpl:282
						} else {
							//line tables/table_view.qtpl:282
							qw422016.N().S(`
                                    `)
							//line tables/table_view.qtpl:283
							qw422016.E().S(val)
							//line tables/table_view.qtpl:283
							qw422016.N().S(`
                                 `)
							//line tables/table_view.qtpl:284
						}
						//line tables/table_view.qtpl:284
						qw422016.N().S(`
                            `)
						//line tables/table_view.qtpl:285
					}
					//line tables/table_view.qtpl:285
					qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:286
				}
				//line tables/table_view.qtpl:286
				qw422016.N().S(`
                `)
				//line tables/table_view.qtpl:287
			}
			//line tables/table_view.qtpl:287
			qw422016.N().S(`
                </div> <!-- field -->
            `)
			//line tables/table_view.qtpl:289
		}
		//line tables/table_view.qtpl:289
		qw422016.N().S(`
            `)
		//line tables/table_view.qtpl:290
		for _, fieldStruct := range query.PostFields {
			//line tables/table_view.qtpl:290
			qw422016.N().S(`
                <div name="`)
			//line tables/table_view.qtpl:291
			...
			qw422016.N().S(`"
                         style="`)
			//line tables/table_view.qtpl:292
			qw422016.E().S(fieldStruct.CSSStyle)
			//line tables/table_view.qtpl:292
			qw422016.N().S(`;margin:auto; height:auto;" >
                    `)
			//line tables/table_view.qtpl:293
			qw422016.N().S(fieldStruct.Html)
			//line tables/table_view.qtpl:293
			qw422016.N().S(`
                </div> <!-- field -->
            `)
			//line tables/table_view.qtpl:295
		}
		//line tables/table_view.qtpl:295
		qw422016.N().S(`
        </div> <!-- tr -->
        `)
		//line tables/table_view.qtpl:297
	}
	//line tables/table_view.qtpl:297
	qw422016.N().S(`
    </div>
...
`)
//line tables/table_view.qtpl:300
}
...
func streamrenderFilterSelect(qw422016 *qt422016.Writer, key string, fieldStruct *forms.FieldStructure) {
	...
	qw422016.N().S(`" onchange="return FilterIsModified( event, this);">
        ...
        `)
	//line tables/table_view.qtpl:304
	qw422016.N().S(fieldStruct.Html)
	//line tables/table_view.qtpl:304
	qw422016.N().S(`
    </select>
`)
//line tables/table_view.qtpl:306
}
...
func streaminputFilterField(qw422016 *qt422016.Writer, key, nameTable string, fieldStruct *forms.FieldStructure) {
 ...
 <div title="`)
	...
	qw422016.N().S(`">
                        `)
	//line tables/table_view.qtpl:309
	if key == "parent_id" {
		//line tables/table_view.qtpl:309
		qw422016.N().S(`
                                `)
		//line tables/table_view.qtpl:310
		fieldStruct.GetOptions(nameTable, "")

		//line tables/table_view.qtpl:310
		qw422016.N().S(`
                                `)
		//line tables/table_view.qtpl:311
		streamrenderFilterSelect(qw422016, key, fieldStruct)
		//line tables/table_view.qtpl:311
		qw422016.N().S(`
                        `)
		//line tables/table_view.qtpl:312
	} else if strings.HasPrefix(key, "id_") {
		//line tables/table_view.qtpl:312
		qw422016.N().S(`
                                `)
		//line tables/table_view.qtpl:313
		fieldStruct.GetOptions(key[3:], "")

		//line tables/table_view.qtpl:313
		qw422016.N().S(`
                                `)
		//line tables/table_view.qtpl:314
		streamrenderFilterSelect(qw422016, key, fieldStruct)
		//line tables/table_view.qtpl:314
		qw422016.N().S(`
                        `)
		//line tables/table_view.qtpl:315
	} else {
		//line tables/table_view.qtpl:315
		qw422016.N().S(`
                            `)
		//line tables/table_view.qtpl:316
		switch fieldStruct.DATA_TYPE {
		//line tables/table_view.qtpl:317
		case "tinyint":
			//line tables/table_view.qtpl:317
			qw422016.N().S(`
                                    `)
			//line tables/table_view.qtpl:318
			forms.StreamRenderCheckBox(qw422016, key, "1", "", 1, "", "", "", "")
			//line tables/table_view.qtpl:318
			qw422016.N().S(`
                            `)
		//line tables/table_view.qtpl:319
		case "enum":
			//line tables/table_view.qtpl:319
			qw422016.N().S(`
                                `)
			//line tables/table_view.qtpl:320
			t := fieldStruct.RenderEnum(key, "", "", "", "")

			//line tables/table_view.qtpl:320
			qw422016.N().S(`
                                `)
			//line tables/table_view.qtpl:321
			qw422016.N().S(t)
			//line tables/table_view.qtpl:321
			qw422016.N().S(`
                            `)
		//line tables/table_view.qtpl:322
		case "set":
			//line tables/table_view.qtpl:322
			qw422016.N().S(`
                                `)
			//line tables/table_view.qtpl:323
			t := fieldStruct.RenderSet(key, "", "", "", "")

			//line tables/table_view.qtpl:323
			qw422016.N().S(`
                                `)
			//line tables/table_view.qtpl:324
			qw422016.N().S(t)
			//line tables/table_view.qtpl:324
			qw422016.N().S(`
               `)
		//line tables/table_view.qtpl:325
		default:
			//line tables/table_view.qtpl:325
			qw422016.N().S(`
                        <input id="`)
			//line tables/table_view.qtpl:326
			qw422016.E().S(key)
			//line tables/table_view.qtpl:326
			qw422016.N().S(`" name="`)
			//line tables/table_view.qtpl:326
			...
			qw422016.N().S(`" type=
                        ...
                        `)
			//line tables/table_view.qtpl:328
			if fieldStruct.InputType > "" {
				//line tables/table_view.qtpl:328
				qw422016.N().S(`
                            "`)
				//line tables/table_view.qtpl:329
				qw422016.E().S(fieldStruct.InputType)
				//line tables/table_view.qtpl:329
				qw422016.N().S(`"
                        `)
				//line tables/table_view.qtpl:330
			} else if fieldStruct.DATA_TYPE == "int" || fieldStruct.DATA_TYPE == "double" {
				//line tables/table_view.qtpl:330
				qw422016.N().S(`
                            "number" `)
				//line tables/table_view.qtpl:331
				...
				qw422016.N().S(`
                        `)
				//line tables/table_view.qtpl:332
			} else if fieldStruct.DATA_TYPE == "date" {
				//line tables/table_view.qtpl:332
				qw422016.N().S(`
                            "date"  `)
				//line tables/table_view.qtpl:333
				fieldStruct.StreamRenderDateAttributtes(qw422016)
				//line tables/table_view.qtpl:333
				qw422016.N().S(`
                        `)
				//line tables/table_view.qtpl:334
			} else if fieldStruct.DATA_TYPE == "datetime" {
				//line tables/table_view.qtpl:334
				qw422016.N().S(`
                            "datetime" `)
				//line tables/table_view.qtpl:335
				fieldStruct.StreamRenderDateAttributtes(qw422016)
				//line tables/table_view.qtpl:335
				qw422016.N().S(`
                        `)
				//line tables/table_view.qtpl:336
			} else if strings.Contains(key, "email") {
				//line tables/table_view.qtpl:336
				qw422016.N().S(`
                            "email"
                        `)
				//line tables/table_view.qtpl:338
			} else {
				//line tables/table_view.qtpl:338
				qw422016.N().S(`
                            "text"
                               `)
				//line tables/table_view.qtpl:340
				if fieldStruct.CHARACTER_MAXIMUM_LENGTH > 0 {
					//line tables/table_view.qtpl:340
					qw422016.N().S(`
                                    maxlength="`)
					//line tables/table_view.qtpl:341
					qw422016.N().D(fieldStruct.CHARACTER_MAXIMUM_LENGTH)
					//line tables/table_view.qtpl:341
					qw422016.N().S(`"
                               `)
					//line tables/table_view.qtpl:342
				}
				//line tables/table_view.qtpl:342
				qw422016.N().S(`
                        `)
				//line tables/table_view.qtpl:343
			}
			//line tables/table_view.qtpl:343
			qw422016.N().S(`
                        ...
                        />
               `)
			//line tables/table_view.qtpl:346
		}
		//line tables/table_view.qtpl:346
		qw422016.N().S(`
        `)
		//line tables/table_view.qtpl:347
	}
	//line tables/table_view.qtpl:347
	qw422016.N().S(`
  </div>
`)
//line tables/table_view.qtpl:349
}
