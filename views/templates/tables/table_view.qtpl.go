...
<table class="table table-striped table-bordered table-hover table-condensed">
	...
	for idx, fieldName := range query.columns {
		...
		qw422016.N().S(`
                <td>`)
		//line tables/table_view.qtpl:21
...
func (query *QueryStruct) StreamRenderTable(qw422016 *qt422016.Writer) {
	...
	//line tables/table_view.qtpl:45
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:46
	query.streamrenderHeadTables(qw422016)
	//line tables/table_view.qtpl:46
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:47
	query.streamrenderBodyTables(qw422016)
	//line tables/table_view.qtpl:47
	qw422016.N().S(`
`)
//line tables/table_view.qtpl:48
}
...
func StreamShowTable(qw422016 *qt422016.Writer, tableName string, fields forms.FieldsTable, rows *sql.Rows) {
	...
	//line tables/table_view.qtpl:60
	qw422016.N().S(`
        `)
	...
	qw422016.N().S(`
        `)
	//line tables/table_view.qtpl:62
	query.streamrenderBodyTables(qw422016)
	//line tables/table_view.qtpl:62
	qw422016.N().S(`
`)
//line tables/table_view.qtpl:63
}
...
//line tables/table_view.qtpl:64
func (query *QueryStruct) streamrenderBodyTables(qw422016 *qt422016.Writer) {
	//line tables/table_view.qtpl:64
	qw422016.N().S(`
    <tbody>
        `)
	//line tables/table_view.qtpl:66
	for query.Rows.Next() {
		//line tables/table_view.qtpl:66
		qw422016.N().S(`
            `)
		//line tables/table_view.qtpl:68
		...
		for idx, rawField := range query.row {
			...
			//line tables/table_view.qtpl:98
			qw422016.N().S(`
                `)
			//line tables/table_view.qtpl:99
			if idx == 0 {
				//line tables/table_view.qtpl:99
				qw422016.N().S(`
                    <td><a href="`)
				//line tables/table_view.qtpl:100
				...
				qw422016.N().S(`
                `)
				//line tables/table_view.qtpl:106
			} else {
				//line tables/table_view.qtpl:106
				qw422016.N().S(`
                `)
				//line tables/table_view.qtpl:109
				qw422016.N().S(`
                    <td class="`)
				//line tables/table_view.qtpl:110
				...
				qw422016.N().S(`">
                        `)
				//line tables/table_view.qtpl:111
				if key == "parent_id" {
					//line tables/table_view.qtpl:111
					qw422016.N().S(`
                            `)
					...
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:118
					...
					qw422016.N().S(`
                            `)
					//line tables/table_view.qtpl:120
					switch fieldStruct.DATA_TYPE {
					//line tables/table_view.qtpl:121
					case "tinyint":
						//line tables/table_view.qtpl:121
						qw422016.N().S(`
                                    `)
						//line tables/table_view.qtpl:123
						checked := ""
						if val == "1" {
							checked = "checked"
						}

						//line tables/table_view.qtpl:127
						qw422016.N().S(`
                                    `)
						//line tables/table_view.qtpl:128
						forms.StreamRenderCheckBox(qw422016, nameInput, "1", titleLabel, 1, checked, events, dataJson)
						//line tables/table_view.qtpl:128
						qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:129
					case "enum":
						//line tables/table_view.qtpl:129
						qw422016.N().S(`
                            `)
						//line tables/table_view.qtpl:130
						t := fieldStruct.RenderEnum(nameInput, val, required, events, dataJson)

						//line tables/table_view.qtpl:130
						qw422016.N().S(`
                            `)
						//line tables/table_view.qtpl:131
						qw422016.N().S(t)
						//line tables/table_view.qtpl:131
						qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:132
					case "set":
						//line tables/table_view.qtpl:132
						qw422016.N().S(`
                            `)
						//line tables/table_view.qtpl:133
						t := fieldStruct.RenderSet(nameInput, val, required, events, dataJson)

						//line tables/table_view.qtpl:133
						qw422016.N().S(`
                            `)
						//line tables/table_view.qtpl:134
						qw422016.N().S(t)
						//line tables/table_view.qtpl:134
						qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:135
					case "blob", "text":
						//line tables/table_view.qtpl:135
						qw422016.N().S(`
                            <textarea id="`)
						//line tables/table_view.qtpl:136
						qw422016.E().S(key)
						//line tables/table_view.qtpl:136
						qw422016.N().S(`" name="`)
						//line tables/table_view.qtpl:136
						...
						qw422016.N().S(`>
                                `)
						//line tables/table_view.qtpl:137
						qw422016.N().S(val)
						//line tables/table_view.qtpl:137
						qw422016.N().S(`
                            </textarea>
                            `)
					//line tables/table_view.qtpl:139
					default:
						//line tables/table_view.qtpl:139
						qw422016.N().S(`
                                `)
						//line tables/table_view.qtpl:140
						qw422016.E().S(val)
						//line tables/table_view.qtpl:140
						qw422016.N().S(`
                            `)
						//line tables/table_view.qtpl:141
					}
					//line tables/table_view.qtpl:141
					qw422016.N().S(`
                        `)
					//line tables/table_view.qtpl:142
				}
				//line tables/table_view.qtpl:142
				qw422016.N().S(`
                    </td>
