...
func (ns *FieldsTable) StreamShowRecord(qw422016 *qt422016.Writer, Title string) {
    ...
    <div>
        <h2>Title string</h2>
        `)
	//line forms/record.qtpl:8
	for idx, field := range ns.Rows {
		//line forms/record.qtpl:8
		qw422016.N().S(`
        <div id="divField`)
		//line forms/record.qtpl:9
		qw422016.N().D(idx)
		//line forms/record.qtpl:9
        ...
        >
            `)
		//line forms/record.qtpl:12
		qw422016.E().S(field.Value)
		//line forms/record.qtpl:12
		qw422016.N().S(`
        </div>
        `)
		//line forms/record.qtpl:14
	}
	//line forms/record.qtpl:14
	qw422016.N().S(`
