...
//line forms/signupForm.qtpl:58
func (d *PersonData) StreamJSON(qw422016 *qt422016.Writer) {
	//line forms/signupForm.qtpl:58
	qw422016.N().S(`{"login": "`)
	//line forms/signupForm.qtpl:60
	qw422016.E().S(d.Login)
	//line forms/signupForm.qtpl:60
	qw422016.N().S(`","email": "`)
	//line forms/signupForm.qtpl:61
	qw422016.E().S(d.Email)
	//line forms/signupForm.qtpl:61
	qw422016.N().S(`","sex": "`)
	//line forms/signupForm.qtpl:62
	if d.Sex == 0 {
		//line forms/signupForm.qtpl:62
	...
	//line forms/signupForm.qtpl:62
	qw422016.N().S(`","Rows":[`)
	//line forms/signupForm.qtpl:64
	for i, r := range d.Rows {
		//line forms/signupForm.qtpl:64
		qw422016.N().S(`{"Msg":`)
		//line forms/signupForm.qtpl:66
		qw422016.N().Q(r.Msg)
		//line forms/signupForm.qtpl:66
		qw422016.N().S(`,"N":`)
		//line forms/signupForm.qtpl:67
		qw422016.N().D(r.N)
		//line forms/signupForm.qtpl:67
		qw422016.N().S(`}`)
		//line forms/signupForm.qtpl:69
		if i+1 < len(d.Rows) {
			//line forms/signupForm.qtpl:69
			qw422016.N().S(`,`)
			//line forms/signupForm.qtpl:69
		}
		//line forms/signupForm.qtpl:70
	}
	//line forms/signupForm.qtpl:70
	qw422016.N().S(`]}`)
//line forms/signupForm.qtpl:73
}
