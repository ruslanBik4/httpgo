...
//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:1
package forms
...
//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:2
var (
	_ = qtio422016.Copy
...
<form target="content" action="/user/signup/" method="post"  enctype="multipart/form-data"
	...
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:18
...
`)
//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:40
}
...
//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:42
...
//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:58
func (d *PersonData) StreamJSON(qw422016 *qt422016.Writer) {
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:58
	qw422016.N().S(`{"login": "`)
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:60
	qw422016.E().S(d.Login)
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:60
	qw422016.N().S(`","email": "`)
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:61
	qw422016.E().S(d.Email)
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:61
	qw422016.N().S(`","sex": "`)
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:62
	if d.Sex == 0 {
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:62
	...
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:62
	qw422016.N().S(`","Rows":[`)
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:64
	for i, r := range d.Rows {
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:64
		qw422016.N().S(`{"Msg":`)
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:66
		qw422016.N().Q(r.Msg)
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:66
		qw422016.N().S(`,"N":`)
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:67
		qw422016.N().D(r.N)
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:67
		qw422016.N().S(`}`)
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:69
		if i+1 < len(d.Rows) {
			//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:69
			qw422016.N().S(`,`)
			//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:69
		}
		//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:70
	}
	//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:70
	qw422016.N().S(`]}`)
//line ../../ruslanBik4/httpgo/views/templates/forms/signupForm.qtpl:73
}
