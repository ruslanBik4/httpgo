...
//line forms/anothersignupForm.qtpl:1
package forms
...
//line forms/anothersignupForm.qtpl:2
var (
	_ = qtio422016.Copy
...
<form target="content" action="/admin/anothersignup/" method="post"  enctype="multipart/form-data"
	...
	//line forms/anothersignupForm.qtpl:18
...
`)
//line forms/anothersignupForm.qtpl:38
}
...
//line forms/anothersignupForm.qtpl:40
...
//line forms/anothersignupForm.qtpl:56
func (d *AnotherPersonData) StreamJSON(qw422016 *qt422016.Writer) {
	//line forms/anothersignupForm.qtpl:56
	qw422016.N().S(`{"login": "`)
	//line forms/anothersignupForm.qtpl:58
	qw422016.E().S(d.Login)
	//line forms/anothersignupForm.qtpl:58
	qw422016.N().S(`","email": "`)
	//line forms/anothersignupForm.qtpl:59
	qw422016.E().S(d.Email)
	//line forms/anothersignupForm.qtpl:59
	qw422016.N().S(`","sex": "`)
	//line forms/anothersignupForm.qtpl:60
	if d.Sex == 0 {
		//line forms/anothersignupForm.qtpl:60
	...
	//line forms/anothersignupForm.qtpl:60
	qw422016.N().S(`","Rows":[`)
	//line forms/anothersignupForm.qtpl:62
	for i, r := range d.Rows {
		//line forms/anothersignupForm.qtpl:62
		qw422016.N().S(`{"Msg":`)
		//line forms/anothersignupForm.qtpl:64
		qw422016.N().Q(r.Msg)
		//line forms/anothersignupForm.qtpl:64
		qw422016.N().S(`,"N":`)
		//line forms/anothersignupForm.qtpl:65
		qw422016.N().D(r.N)
		//line forms/anothersignupForm.qtpl:65
		qw422016.N().S(`}`)
		//line forms/anothersignupForm.qtpl:67
		if i+1 < len(d.Rows) {
			//line forms/anothersignupForm.qtpl:67
			qw422016.N().S(`,`)
			//line forms/anothersignupForm.qtpl:67
		}
		//line forms/anothersignupForm.qtpl:68
	}
	//line forms/anothersignupForm.qtpl:68
	qw422016.N().S(`]}`)
//line forms/anothersignupForm.qtpl:71
}
