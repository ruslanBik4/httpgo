...
//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:1
package forms
...
//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:2
var (
	_ = qtio422016.Copy
...
<form target="content" action="/admin/anothersignup/" method="post"  enctype="multipart/form-data"
	...
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:18
...
`)
//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:38
}
...
//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:40
...
//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:56
func (d *AnotherPersonData) StreamJSON(qw422016 *qt422016.Writer) {
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:56
	qw422016.N().S(`{"login": "`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:58
	qw422016.E().S(d.Login)
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:58
	qw422016.N().S(`","email": "`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:59
	qw422016.E().S(d.Email)
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:59
	qw422016.N().S(`","sex": "`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:60
	if d.Sex == 0 {
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:60
	...
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:60
	qw422016.N().S(`","Rows":[`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:62
	for i, r := range d.Rows {
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:62
		qw422016.N().S(`{"Msg":`)
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:64
		qw422016.N().Q(r.Msg)
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:64
		qw422016.N().S(`,"N":`)
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:65
		qw422016.N().D(r.N)
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:65
		qw422016.N().S(`}`)
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:67
		if i+1 < len(d.Rows) {
			//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:67
			qw422016.N().S(`,`)
			//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:67
		}
		//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:68
	}
	//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:68
	qw422016.N().S(`]}`)
//line src/github.com/ruslanBik4/httpgo/views/templates/forms/anothersignupForm.qtpl:71
}
