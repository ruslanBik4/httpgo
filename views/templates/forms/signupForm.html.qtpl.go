...
//line signupForm.html.qtpl:53
func (d *PersonData) StreamJSON(qw422016 *qt422016.Writer) {
	//line signupForm.html.qtpl:53
	qw422016.N().S(`{"login": "`)
	//line signupForm.html.qtpl:55
	qw422016.E().S(d.Login)
	//line signupForm.html.qtpl:55
	qw422016.N().S(`","email": "`)
	//line signupForm.html.qtpl:56
	qw422016.E().S(d.Email)
	//line signupForm.html.qtpl:56
	qw422016.N().S(`","sex": "`)
	//line signupForm.html.qtpl:57
	if d.Sex == 0 {
		//line signupForm.html.qtpl:57
	...
	//line signupForm.html.qtpl:57
	qw422016.N().S(`","Rows":[`)
	//line signupForm.html.qtpl:59
	for i, r := range d.Rows {
		//line signupForm.html.qtpl:59
		qw422016.N().S(`{"Msg":`)
		//line signupForm.html.qtpl:61
		qw422016.N().Q(r.Msg)
		//line signupForm.html.qtpl:61
		qw422016.N().S(`,"N":`)
		//line signupForm.html.qtpl:62
		qw422016.N().D(r.N)
		//line signupForm.html.qtpl:62
		qw422016.N().S(`}`)
		//line signupForm.html.qtpl:64
		if i+1 < len(d.Rows) {
			//line signupForm.html.qtpl:64
			qw422016.N().S(`,`)
			//line signupForm.html.qtpl:64
		}
		//line signupForm.html.qtpl:65
	}
	//line signupForm.html.qtpl:65
	qw422016.N().S(`]}`)
//line signupForm.html.qtpl:68
}
