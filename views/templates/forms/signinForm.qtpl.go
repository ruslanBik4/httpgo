...
<div id="modal" _="on closeModal add .closing then wait for animationend then remove me">
	...
	<div class="modal-content" >
		<form target="content" hx-post="/user/signin/" enctype="multipart/form-data" method="post" hx-boost="true"  class="form-signing"
			hx-on::after-request='return SaveUser(event);' hx-swap="none" hx-push-url=false>
			<h2 class="form-signing-heading">SignIn</h2>
