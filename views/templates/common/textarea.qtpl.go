...
//line src/github.com/ruslanBik4/httpgo/views/templates/common/textarea.qtpl:1
package common
...
//line src/github.com/ruslanBik4/httpgo/views/templates/common/textarea.qtpl:2
var (
	_ = qtio422016.Copy
...
<textarea  name="`)
	//line src/github.com/ruslanBik4/httpgo/views/templates/common/textarea.qtpl:4
	qw422016.E().S(name)
	//line src/github.com/ruslanBik4/httpgo/views/templates/common/textarea.qtpl:4
	qw422016.N().S(`" class="c-textarea"  placeholder="text"></textarea>

`)
//line src/github.com/ruslanBik4/httpgo/views/templates/common/textarea.qtpl:6
}
