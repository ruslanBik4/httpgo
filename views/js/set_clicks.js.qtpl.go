...
//line set_clicks.js.qtpl:2
	qw422016.N().S("`")
//line set_clicks.js.qtpl:2
	qw422016.N().S(`[${instance.formatDate(dates[0], "Y-m-d")},${instance.formatDate(dates[1], "Y-m-d")}]`)
//line set_clicks.js.qtpl:2
	qw422016.N().S("`")
//line set_clicks.js.qtpl:2
	qw422016.N().S(`;
...
//line set_clicks.js.qtpl:2
	qw422016.N().S("`")
//line set_clicks.js.qtpl:2
	qw422016.N().S(`[${dates[0].toISOString().split('T')[0]},${dates[1].toISOString().split('T')[0]}]`)
//line set_clicks.js.qtpl:2
	qw422016.N().S("`")
//line set_clicks.js.qtpl:2
	qw422016.N().S(`;
