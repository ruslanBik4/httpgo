...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` closure variable regardless of which of the two it came from.
    ...
    // Fixed: this used to bail out (`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`if (token) return;`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`) whenever a token
...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`userStruct`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` to undefined on every reload despite a perfectly
    // valid session existing, and `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`Auth.userStruct`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` never reflected who was
    // actually logged in. Now it always returns the already-known user (the
    // one cached `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`storedUser`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`, no second localStorage read) once there is
    ...
    // Only called from App.init() (via `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`Auth.ensureUser()`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`, wired through
...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`'s IIFE runs the instant the browser executes
    // user.js's <script> tag, synchronously, mid-parse - if htmx.min.js
    // happens to be a later <script> tag on the page, `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`window.htmx`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` doesn't
...
//line user.js.qtpl:2
    ...
    // Fixed vs. the pre-refactor version: `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`urlAfterLogin.onsubmit`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` was
    ...
    function beginReauth() {
        if (!reauthPromise) {
            ...
            reauthTimeout = setTimeout(() => {
                ...
                // reauthResolve, not the executor's own `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
...
//line user.js.qtpl:2
    ...
    function resolveRequest(elt) {
        for (const verb of ['get', 'post', 'put', 'patch', 'delete']) {
            const path = elt.getAttribute && elt.getAttribute(`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`hx-${verb}`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`);
...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` (loadContent()/appendTable()/loadTableWithOrder(), all of which
    // call htmx.ajax() with no `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`source`)
...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` defaults to document.body)
    // fell back to overwriting a single `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`urlAfterLogin`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` string. That loses
...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`loginValue`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` is whatever identifies the account (email/username) - the
    ...
    // successful begin, which always just falls through to `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
...
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`, a direct `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`onsubmit="return
    // Auth.login(...)"`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` wiring would always see a Promise back, which the
    ...
    // async function runs before its first `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`await`)
...
//line user.js.qtpl:2
    ...
    // #content and only closes on its own explicit `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`closeModal`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(` event (see
    // its hyperscript: `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`_="on closeModal add .closing then wait for
    // animationend then remove me"`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`). Without this, a passkey login left
    ...
    // ensureUser() above. App.init() (app.js, wired via `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`$(App.init)`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`) is
...
// Replaces app.js's old `)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`function relogin(url) { return App.relogin(url); }`)
//line user.js.qtpl:2
	qw422016.N().S("`")
//line user.js.qtpl:2
	qw422016.N().S(`
