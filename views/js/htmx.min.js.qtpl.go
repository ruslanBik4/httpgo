// Code generated by qtc from "htmx.min.js.qtpl". DO NOT EDIT.
// See https://github.com/valyala/quicktemplate for details.

//line htmx.min.js.qtpl:1
package js
...
//line htmx.min.js.qtpl:2
	qw422016.N().S("`")
//line htmx.min.js.qtpl:2
	qw422016.N().S(`.${t}{opacity:0;visibility: hidden} `)
//line htmx.min.js.qtpl:2
	qw422016.N().S("`")
//line htmx.min.js.qtpl:2
	qw422016.N().S(`+`)
//line htmx.min.js.qtpl:2
	qw422016.N().S("`")
//line htmx.min.js.qtpl:2
	qw422016.N().S(`.${n} .${t}, .${n}.${t}{opacity:1;visibility: visible;transition: opacity 200ms ease-in}`)
//line htmx.min.js.qtpl:2
	qw422016.N().S("`")
//line htmx.min.js.qtpl:2
	qw422016.N().S(`+"</style>")}}function Zn(){const e=te().querySelector('meta[name="htmx-config"]');if(e){return v(e.content)}else{return null}}function Yn(){const e=Zn();if(e){Q.config=le(Q.config,e)}}Gn(function(){Yn();Wn();let e=te().body;Ft(e);const t=te().querySelectorAll("[hx-trigger='restored'],[data-hx-trigger='restored']");e.addEventListener("htmx:abort",function(e){const t=e.detail.elt||e.target;const n=oe(t);if(n&&n.xhr){n.xhr.abort()}});const n=window.onpopstate?window.onpopstate.bind(window):null;window.onpopstate=function(e){if(e.state&&e.state.htmx){en();ie(t,function(e){ae(e,"htmx:restored",{document:te(),triggerEvent:ae})})}else{if(n){n(e)}}};b().setTimeout(function(){ae(e,"htmx:load",{});e=null},0)});return Q}();`)
//line htmx.min.js.qtpl:2
	qw422016.N().S(`
`)
//line htmx.min.js.qtpl:3
}

//line htmx.min.js.qtpl:3
func WriteHTMX(qq422016 qtio422016.Writer) {
//line htmx.min.js.qtpl:3
