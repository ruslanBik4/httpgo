  ...
  _createClass(Parse, null, [{
    ...
    */
    ...
    value: function _APIGetRequest(componentDom) {
      ...
      componentDom.querySelectorAll('[' + Variables.routerAPIGET + ']').forEach(function (component) {
        ...
        var src = component.getAttribute(Variables.routerAPIPOST);
    ...
    */
    ...
    value: function _importScript(component) {
      var arrayScript = component.querySelectorAll(Variables.dynamicallyScript);
      debugger;
      ...
      try {
        for (var _iterator2 = scriptObject[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
