          ...
          if (Object.prototype.toString.call(attr) === '[object Array]') {
            ...
            try {
              for (var _iterator = attr[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                if (!func) {
                  func = _this.components[currentComponent.tagName];
                }
        ...
        for (var id in data[index]) {
          ...
          if (_component) {
            ...
            if (data[index][id].length !== 0) {
              insertValueCurrentComponent(_component, data[index][id]);
            }
            setNewAttrIdAndName(_component, index);
          }
        }
        ...
        for (index++; index < data.length; index++) {
          ...
          for (var _id in data[index]) {
            ...
            if (_component2 && data[index][_id].length !== 0) {
              insertValueCurrentComponent(_component2, data[index][_id]);
              setNewAttrIdAndName(_component2, index);
            }
          }
