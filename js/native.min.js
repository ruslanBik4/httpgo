  ...
  _createClass(ParseJSON, null, [{
    ...
    */
    ...
    value: function insertValueToComponent(component, attr) {
      ...
      var tableIdParse = function tableIdParse(data, strForTable) {
        ...
        for (var id in data[index]) {
          var _component = document.getElementById(strForTable + ':' + id) || document.getElementById(strForTable + ':' + id + '[]');
          if (_component) {
            if (!parent) {
        ...
        for (index++; index < data.length; index++) {
          ...
          for (var _id in data[index]) {
            ...
            var _component2 = document.querySelector('[name="' + strForTable + ':' + _id + '"]') || document.querySelector('[name="' + strForTable + ':' + _id + '[]"]');
...
var paramsFormChildren = 'data-form';
