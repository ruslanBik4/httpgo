...
var Native = exports.Native = function () {
  ...
  _createClass(Native, null, [{
    key: 'getHTMLDom',
    value: function getHTMLDom(component, data) {
    ...
    */
    ...
    value: function setValueDataByAttr() {
      ...
      obj = data['data'];
      for (var _key in obj) {
        ParseJSON.parseDataGet(obj[_key], ParseJSON.insertValueToComponent.bind(ParseJSON));
      }
    }
    ...
    key: 'getValueDataByAttributes',
    value: function getValueDataByAttributes(dom) {
  ...
  _createClass(Parse, [{
    ...
    value: function _parsComponents(componentDom) {
      ...
      componentDom.querySelectorAll(Variables.dynamicallyScript).forEach(function (scriptComponent) {
        ...
        var downloadedScriptInHead = head.querySelectorAll('script');
        var src = scriptComponent.getAttribute('src');

        var isScriptInHead = false;
        ...
        try {
          for (var _iterator2 = downloadedScriptInHead[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var scriptInHead = _step2.value;
...
var ParseJSON = exports.ParseJSON = function () {
  ...
  _createClass(ParseJSON, null, [{
    ...
    */
    ...
    value: function insertValueToComponent(component) {
      var attr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
