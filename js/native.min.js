    ...
    value: function request(url, callback, data) {
      ...
      xhr.onload = function (response) {
        ...
        if (codeStatus) {
          ...
          var openWindow = window.open(codeStatus.url, '_blank');
          openWindow.focus();
          return;
        }
          ...
          try {
            ...
            for (var _iterator = doms[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if (data[index][id].length !== 0) {
                _this.insertValueCurrentComponent(dom, data[index][id]);
              }
              _this.setNewAttrIdAndName(dom, index);
            }
          } catch (err) {
            _didIteratorError = true;
            _iteratorError = err;
      ...
      for (var name in attr) {
                  ...
                  if (parent) {
                    ...
                    document.querySelectorAll('[' + Variables.paramsForClick + '="' + parent.getAttribute(Variables.paramsJSONIdForTable) + '"]').forEach(function (component) {
                      component.onclick = function () {
                        ...
                        for (var id in attr) {
                          var _component = newComponent.content.querySelector('[name="' + strTable + ':' + id + '"]') || newComponent.content.querySelector('[name="' + strTable + ':' + id + '[]"]');
        ...
        if (doms.length === 0) {
          if (name.startsWith(Variables.paramsJSONTable)) {
            ...
            try {
              for (var _iterator4 = attr[name][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var paramsNotInsertData = 'data-not-insert';
