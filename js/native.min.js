  ...
  _createClass(Native, null, [{
    ...
    */
    ...
    value: function setValueDataByAttr() {
      ...
      obj = data['data'];
      for (var _key in obj) {
        this._insertDataToDom(obj[_key], this._insertValueToDom);
      }
    }
  }, {
    key: '_insertValueToDom',
    value: function _insertValueToDom(element) {
    ...
    key: '_insertDataToDom',
    value: function _insertDataToDom(data, callback) {
    ...
    value: function _setValueAttrByComponent(element) {
      ...
      for (var attr in params) {
        if (attr !== Variables.paramsJSONList) {
          element.setAttribute(attr, params[attr]);
        }
      }

      if (params[Variables.paramsJSONList]) {
        this._addListToComponent(element, params[Variables.paramsJSONList]);
      } else {
        this._addListToComponent(element, params);
      }
    }
