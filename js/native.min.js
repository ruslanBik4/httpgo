      ...
      componentDom.querySelectorAll('' + Variables.nameForm).forEach(function (component) {
        ...
        component.onsubmit = function () {
          ...
          saveForm(this, function (data, form) {
            ...
            if (_customHadlerAfterForm) {
              result = _customHadlerAfterForm(data, form);
            }
    ...
    */
    ...
    value: function insertValueToComponent(component, attr) {
      ...
      var tableIdParse = function tableIdParse(curComponent, data, strForTable) {
        ...
        for (var id in data[index]) {
          var _getDom2 = _this._getDom(curComponent, id, strForTable),
              _getDom3 = _slicedToArray(_getDom2, 1),
              _component = _getDom3[0];
          ...
          if (_component) {
            ...
            if (data[index][id].length !== 0) {
              _this.insertValueCurrentComponent(_component, data[index][id]);
            }
            _this.setNewAttrIdAndName(_component, index);
          }
        }
        ...
        for (index++; index < data.length; index++) {
          ...
          for (var _id in data[index]) {
            var _getDom4 = _this._getDom(newComponent.content.firstElementChild, _id, strForTable),
                _getDom5 = _slicedToArray(_getDom4, 1),
                _component2 = _getDom5[0];

            if (_component2 && data[index][_id].length !== 0) {
              _this.insertValueCurrentComponent(_component2, data[index][_id]);
              _this.setNewAttrIdAndName(_component2, index);
            }
          }
    ...
    value: function setValue(component, attr, callback) {
      ...
      for (var name in attr) {
        var _getDom6 = this._getDom(component, name, strTable, isDefault || isOnlyClass ? '' : str),
            _getDom7 = _slicedToArray(_getDom6, 2),
            doms = _getDom7[0],
            nameField = _getDom7[1];
          ...
          for (var _iterator = doms[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (name.startsWith(Variables.paramsJSONTable)) {
                    ...
                    if (parent && parent.getAttribute(Variables.paramsJSONIdForTable).length === 0) {
                      ...
                      document.querySelectorAll('[' + Variables.paramsForClick + '="' + parent.getAttribute(Variables.paramsJSONIdForTable) + '"]').forEach(function (component) {
                        component.onclick = function () {
                          ...
                          for (var id in attr) {
                            var _component3 = newComponent.content.querySelector('[name="' + strTable + ':' + id + '"]') || newComponent.content.querySelector('[name="' + strTable + ':' + id + '[]"]');

                            if (_component3) {
                              _component3.setAttribute('id', _component3.getAttribute('id') + '-' + idParent);
                              _this2.setAttrToComponent(_component3, attr[id]);
                              _this2.setNewAttrIdAndName(_component3, index);
                            }
                          }
              ...
              try {
                ...
                for (var _iterator2 = attr[name][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var paramsJSONIdData = 'data-id';
var paramsForm = 'data-form-id';
var paramsFormChildren = 'form';
var paramsForClick = 'native-click-button';
var paramsChangeId = 'native-change-id';
    ...
    */
    ...
    value: function addAttrToComponent(component, attr) {
      ...
      if (component.children.length !== 0) {
        ...
        for (var i = 0; i < component.children.length; i++) {
          var option = component.children[i];
