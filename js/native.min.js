  ...
  _createClass(Parse, [{
    ...
    value: function _parsComponents(componentDom) {
      ...
      componentDom.querySelectorAll(Variables.dynamicallyScript).forEach(function (scriptComponent) {
        ...
        try {
          for (var _iterator = downloadedScriptInHead[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var scriptInHead = _step.value;
